...
@property (nonatomic, strong) NSArray *imageArray;//本地图片
@property (nonatomic, strong) NSArray *imageUrlArray;//网络加载图片
@property (nonatomic, assign) BOOL needPageControl; //default is YES.//是否显示分页控制器
@property (nonatomic, assign) BOOL infiniteLoop;    //default is NO.//无限制循环
@property (nonatomic, strong) NSString *placeHolderImageName;//展位图片.
//小圆点位置类型
