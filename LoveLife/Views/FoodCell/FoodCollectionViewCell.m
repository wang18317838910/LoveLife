...
- (void)createUI
{
    ...
    UIButton *playButton = [FactoryUI createButtonWithFrame:CGRectMake(0, 0, 40, 40) title:nil titleColor:nil imageName:@"iconfont-bofang" backgroundImageName:nil target:self selector:@selector(playButtonClick)];
